...
var init_web = __esm({
  "browser-external:stream/web"() {
    web_default = new Proxy({}, {
      get() {
        throw new Error('Module "stream/web" has been externalized for browser compatibility and cannot be accessed in client code.');
      }
    });
  }
});
...
var require_util = __commonJS({
  "node_modules/undici/lib/core/util.js"(exports, module) {
    ...
    function ReadableStreamFrom(iterable) {
      if (!ReadableStream) {
        ReadableStream = (init_web(), __toCommonJS(web_exports)).ReadableStream;
      }
...
var init_diagnostics_channel = __esm({
  "browser-external:diagnostics_channel"() {
    diagnostics_channel_default = new Proxy({}, {
      get() {
        throw new Error('Module "diagnostics_channel" has been externalized for browser compatibility and cannot be accessed in client code.');
      }
    });
  }
});
...
var require_file = __commonJS({
  "node_modules/undici/lib/fetch/file.js"(exports, module) {
    ...
    var _a;
    module.exports = { File: (_a = globalThis.File) != null ? _a : File, FileLike };
  }
});
...
var require_util2 = __commonJS({
  "node_modules/undici/lib/fetch/util.js"(exports, module) {
    ...
    var { performance } = (init_perf_hooks(), __toCommonJS(perf_hooks_exports));
...
var init_types = __esm({
  "browser-external:util/types"() {
    types_default = new Proxy({}, {
      get() {
        throw new Error('Module "util/types" has been externalized for browser compatibility and cannot be accessed in client code.');
      }
    });
  }
});
...
var require_body = __commonJS({
  "node_modules/undici/lib/fetch/body.js"(exports, module) {
    ...
    var { isUint8Array, isArrayBuffer } = (init_types(), __toCommonJS(types_exports));
    var ReadableStream;
...
var require_request = __commonJS({
  "node_modules/undici/lib/core/request.js"(exports, module) {
    ...
    try {
      const diagnosticsChannel = (init_diagnostics_channel(), __toCommonJS(diagnostics_channel_exports));
...
var require_redirect = __commonJS({
  "node_modules/undici/lib/handler/redirect.js"(exports, module) {
    "use strict";
    var util = require_util();
    var { kBodyUsed } = require_symbols();
    var assert = (init_assert(), __toCommonJS(assert_exports));
  ...
  "node_modules/undici/lib/core/connect.js"(exports, module) {
    ...
    function buildConnector({ maxCachedSessions, socketPath, timeout, ...opts }) {
      ...
      return function connect({ hostname, host, protocol, port, servername, httpSocket }, callback) {
        ...
        if (protocol === "https:") {
          if (!tls) {
            tls = (init_tls(), __toCommonJS(tls_exports));
          }
...
var init_async_hooks = __esm({
  "browser-external:async_hooks"() {
    async_hooks_default = new Proxy({}, {
      get() {
        throw new Error('Module "async_hooks" has been externalized for browser compatibility and cannot be accessed in client code.');
      }
    });
  }
});
...
var require_api_request = __commonJS({
  "node_modules/undici/lib/api/api-request.js"(exports, module) {
    ...
    var util = require_util();
    var { AsyncResource } = (init_async_hooks(), __toCommonJS(async_hooks_exports));
...
var init_console = __esm({
  "browser-external:console"() {
    console_default = new Proxy({}, {
      get() {
        throw new Error('Module "console" has been externalized for browser compatibility and cannot be accessed in client code.');
      }
    });
  }
});
...
var require_pending_interceptors_formatter = __commonJS({
  "node_modules/undici/lib/mock/pending-interceptors-formatter.js"(exports, module) {
    ...
    var { Console } = (init_console(), __toCommonJS(console_exports));
  ...
  "node_modules/undici/lib/fetch/headers.js"(exports, module) {
    ...
    var Headers = class {
      ...
      get [kHeadersSortedMap]() {
        var _a, _b;
        (_b = (_a = this[kHeadersList])[kHeadersSortedMap]) != null ? _b : _a[kHeadersSortedMap] = new Map([...this[kHeadersList]].sort((a, b) => a[0] < b[0] ? -1 : 1));
    ...
    var Request = class {
      constructor(...args) {
        ...
        if (initBody == null && inputBody != null) {
          ...
          if (!TransformStream) {
            TransformStream = (init_web(), __toCommonJS(web_exports)).TransformStream;
          }
...
var require_fetch = __commonJS({
  "node_modules/undici/lib/fetch/index.js"(exports, module) {
    ...
    var { kHeadersList } = require_symbols();
    var EE = (init_events(), __toCommonJS(events_exports));
    var { Readable, pipeline } = (init_stream(), __toCommonJS(stream_exports));
    var { isErrored, isReadable } = require_util();
    var { dataURLProcessor } = require_dataURL();
    var { TransformStream } = (init_web(), __toCommonJS(web_exports));
...
// dep:undici
var undici_default = require_undici();
export {
